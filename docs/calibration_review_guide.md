...
3. `metrics.yaml`
4. `diagnostics/acceptance_report.yaml`
5. `diagnostics/per_pair_reprojection.csv`
6. `diagnostics/leave_one_out_trials.csv`
7. `diagnostics/parent_image_coverage_heatmap.png`
8. `diagnostics/child_image_coverage_heatmap.png`
9. `diagnostics/epipolar_previews/`

Primary signals:

- final RMS and per-pair RMS tail
- holdout repeatability
- epipolar consistency
- parent/child image coverage
- pose depth / tilt diversity
